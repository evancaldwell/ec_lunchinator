...
// var fireServiceAccount = require("rbdcdataviz-firebase-adminsdk-zcsgv-452c7f9a04.json");
fireAdmin.initializeApp({
  // credential: fireAdmin.credential.cert(fireServiceAccount),
  credential: fireAdmin.credential.cert({
    type: "service_account",
    project_id: "rbdcdataviz",
